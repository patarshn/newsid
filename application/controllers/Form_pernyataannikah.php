...
class Form_pernyataannikah extends Frontend_Controller{
    
    private $_table = 'form_pernyataannikah';
    private $_folder = 'form';
    private $_folderUpload = 'form_pernyataannikah';
    private $_docxName = 'form_pernyataannikah';
    private $_mainTitle = 'Form Pernyataan Nikah';  
    private $_fileName = 'form_pernyataannikah';
    ...
    function rulesStore(){
        return [
            ...
            ['field' => 'maskawin', 'label' => 'MASKAWIN', 'rules' => 'required'],
            ['field' => 'tanggal_kawin', 'label' => 'TANGGAL_KAWIN', 'rules' => 'required'],
            ['field' => 'jam_kawin', 'label' => 'JAM_KAWIN', 'rules' => 'required'],
