...
class Buku_tnh_desa extends Admin_Controller {
    ...
    function rulesStore() {
        return [
            ...
            ['field' => 'jml','label' => 'Jumlah', 'rules' => 'required|min_length[1]'],
            ['field' => 'sdh_serti_hm','label' => 'Luas Hak Milik', 'rules' => 'required|min_length[1]'],
            ['field' => 'sdh_serti_hgb','label' => 'Luas Hak Guna Bangunan', 'rules' => 'required|min_length[1]'],
            ['field' => 'sdh_serti_hp','label' => 'Luas Hak Pakai', 'rules' => 'required|min_length[1]'],
            ['field' => 'sdh_serti_hgu','label' => 'Luas Hak Guna Usaha', 'rules' => 'required|min_length[1]'],
            ['field' => 'sdh_serti_hpl','label' => 'Luas Hak Pengelolaan', 'rules' => 'required|min_length[1]'],
            ['field' => 'blm_serti_ma','label' => 'Luas Hak Milik Adat', 'rules' => 'required|min_length[1]'],
            ['field' => 'blm_serti_vi','label' => 'Luas Hak Verponding Indonesia', 'rules' => 'required|min_length[1]'],
            ['field' => 'blm_serti_tn','label' => 'Luas Tanah Negara', 'rules' => 'required|min_length[1]'],
            ['field' => 'non_pertanian_perumahan','label' => 'Luas Perumahan', 'rules' => 'required|min_length[1]'],
            ['field' => 'non_pertanian_dagang_jasa','label' => 'Luas Perdagangan dan Jasa', 'rules' => 'required|min_length[1]'],
            ['field' => 'non_pertanian_kantor','label' => 'Luas Perkantoran', 'rules' => 'required|min_length[1]'],
            ['field' => 'non_pertanian_industri','label' => 'Luas Industri', 'rules' => 'required|min_length[1]'],
            ['field' => 'non_pertanian_fasilitas_umum','label' => 'Luas Fasilitas Umum', 'rules' => 'required|min_length[1]'],
            ['field' => 'pertanian_sawah','label' => 'Luas Sawah', 'rules' => 'required|min_length[1]'],
            ['field' => 'pertanian_tegalan','label' => 'Luas Tegalan', 'rules' => 'required|min_length[1]'],
            ['field' => 'pertanian_kebun','label' => 'Luas Perkebunan', 'rules' => 'required|min_length[1]'],
            ['field' => 'pertanian_ternak','label' => 'Luas Peternakan/Perikanan', 'rules' => 'required|min_length[1]'],
            ['field' => 'pertanian_hutan','label' => 'Luas Hutan Belukar', 'rules' => 'required|min_length[1]'],
            ['field' => 'pertanian_hutan_lindung','label' => 'Luas Hutan Lebat/Lindung', 'rules' => 'required|min_length[1]'],
            ['field' => 'pertanian_tanah_kosong','label' => 'Luas Tanah Kosong', 'rules' => 'required|min_length[1]'],
            ['field' => 'pertanian_lain','label' => 'Luas Tanah Untuk Lain-Lain', 'rules' => 'required|min_length[1]'],
