...
class Form_kehilanganbarang extends Admin_Controller{

    private $_table = 'form_kehilanganbarang';
    private $_folder = 'form_kehilanganbarang';
    private $_folderUpload = 'form_kehilanganbarang';
    private $_docxName = 'form_kehilanganbarang.docx';
