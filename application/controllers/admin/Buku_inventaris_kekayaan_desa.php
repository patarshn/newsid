...
class Buku_inventaris_kekayaan_desa extends Admin_Controller {
    ...
    function rulesStore() {
        return [
            ...
            ['field' => 'abb_dibeli_sendiri','label' => 'Dibeli Sendiri', 'rules' => 'required'],
            ['field' => 'bantuan_pemeritah','label' => 'Bantuan Pemerintah', 'rules' => 'required'],
            ['field' => 'bantuan_prov','label' => 'Bantuan Provinsi', 'rules' => 'required'],
            ['field' => 'bantuan_kab_kota','label' => 'Bantuan Kab/Kota', 'rules' => 'required'],
            ['field' => 'abb_sumbangan','label' => 'Sumbangan', 'rules' => 'required'],
            ['field' => 'baik_awalthn','label' => 'Baik Keadaan Barang atau Bangunan Awal Tahun', 'rules' => 'required'],
            ['field' => 'rusak_awalthn','label' => 'Rusak Keadaan Barang atau Bangunan Awal Tahun', 'rules' => 'required'],
            ['field' => 'rusak_hps','label' => 'Rusak', 'rules' => 'required'],
            ['field' => 'dijual_hps','label' => 'Dijual', 'rules' => 'required'],
            ['field' => 'disumbangkan_hps','label' => 'Disumbangkan', 'rules' => 'required'],
            ['field' => 'tgl_hapus','label' => 'Tanggal Penghapusan', 'rules' => 'required'],
            ['field' => 'baik_akhirthn','label' => 'Baik Keadaan Barang atau Bangunan Akhir Tahun', 'rules' => 'required'],
            ['field' => 'rusak_akhirthn','label' => 'Rusak Keadaan Barang atau Bangunan Akhir Tahun', 'rules' => 'required'],
        ];
    }
