...
class Penduduk_sementara extends Admin_Controller {

    private $_table = 'penduduk_sementara';
    private $_folder = 'penduduk_sementara';
    private $_mainTitle = 'Data Penduduk Sementara';
    ...
    public function store(){
        ...
        if($validation->run()){
            ...
            $data = array(
                ...
                'nama_alamat_datang' => $_POST['nama_alamat_datang'],
