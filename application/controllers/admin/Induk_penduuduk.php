...
class Induk_penduuduk extends Admin_Controller {
    ...
    function rulesStore() {
        return [
            ...
            ['field' => 'nokk','label' => 'Nomor Kartu Keluarga (KK)', 'rules' => 'required'],
            ['field' => 'nama','label' => 'Nama Lengkap/Panggilan', 'rules' => 'required'],
            ['field' => 'jk','label' => 'Jenis Kelamin', 'rules' => 'required'],
            ['field' => 'stkawin','label' => 'Statur Perkawinan', 'rules' => 'required'],
            ...
            ['field' => 'baca_huruf','label' => 'Bisa Membaca Huruf', 'rules' => 'required'],
            ['field' => 'wn','label' => 'Kewarganegaraan', 'rules' => 'required'],
            ['field' => 'alamat','label' => 'Alamat', 'rules' => 'required'],
            ['field' => 'kdd_keluarga','label' => 'Kedudukan di Keluarga', 'rules' => 'required'],
    ...
    public function store(){
        ...
        if($validation->run()){
            ...
            $data = array(
                ...
                'wn' => $_POST['wn'],
                'alamat' => $_POST['alamat'],
                'kdd_keluarga' => $_POST['kdd_keluarga'],
                'ket' => $_POST['ket'],
