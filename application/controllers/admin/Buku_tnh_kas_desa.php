...
class Buku_tnh_kas_desa extends Admin_Controller {
    ...
    function rulesStore() {
        return [
            ['field' => 'asal_tnh_kas','label' => 'Asal Tanah Kas Desa', 'rules' => 'required'],
            ['field' => 'no_serti_letterc_persil','label' => 'Nomor Sertifikat Buku Letter C/Persil', 'rules' => 'required'],
            ['field' => 'luas','label' => 'Luas', 'rules' => 'required'],
            ['field' => 'kelas','label' => 'Kelas', 'rules' => 'required'],
            ['field' => 'peroleh_asli_milik_desa','label' => 'Asli Milik Desa', 'rules' => 'required'],
            ['field' => 'bantuan_pem','label' => 'Bantuan Pemerintah', 'rules' => 'required'],
            ['field' => 'bantuan_prov','label' => 'Bantuan Provinsi', 'rules' => 'required'],
            ['field' => 'bantuan_kab_kota','label' => 'Bantuan Kab/Kota', 'rules' => 'required'],
            ['field' => 'peroleh_lain','label' => 'Lain-Lain', 'rules' => 'required'],
            ['field' => 'tgl_peroleh','label' => 'Tanggal Perolehan', 'rules' => 'required'],
            ['field' => 'jenis_sawah','label' => 'Sawah', 'rules' => 'required'],
            ['field' => 'jenis_tegal','label' => 'Tegal', 'rules' => 'required'],
            ['field' => 'jenis_kebun','label' => 'Kebun', 'rules' => 'required'],
            ['field' => 'jenis_tambak','label' => 'Tambak/Kolam ', 'rules' => 'required'],
            ['field' => 'jenis_darat','label' => 'Tanah Kering/Darat', 'rules' => 'required'],
            ['field' => 'patok_ada','label' => 'Patok Tanda Batas Ada', 'rules' => 'required'],
            ['field' => 'patok_tdkada','label' => 'Patok Tanda Batas Tidak Ada', 'rules' => 'required'],
            ['field' => 'papan_ada','label' => 'Papan Nama Ada', 'rules' => 'required'],
            ['field' => 'papan_tdkada','label' => 'Papan Nama Tidak Ada ', 'rules' => 'required'],
    ...
    function rulesUpdate() {
        return [
            ...
            ['field' => 'papan_tdkada','label' => 'Papan Nama Tidak Ada ', 'rules' => 'required'],
            ['field' => 'lokasi','label' => 'Lokasi', 'rules' => 'required'],
            ['field' => 'peruntukkan','label' => 'Peruntukkan', 'rules' => 'required'],x
        ];
    }
