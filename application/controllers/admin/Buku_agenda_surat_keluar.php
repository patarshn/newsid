...
class Buku_agenda_surat_keluar extends Admin_Controller {
    ...
    function rulesStore() {
        return [
            ...
            ['field' => 'no_surat_keluar','label' => 'Nomor Surat Keluar', 'rules' => 'required'],
            ['field' => 'tgl_surat_keluar','label' => 'Tanggal Surat Keluar', 'rules' => 'required'],
