...
class Buku_keputusan_ppd extends Admin_Controller {

    private $_table = 'buku_keputusan_ppd';
    private $_folder = 'buku_keputusan_ppd';
    private $_mainTitle = 'Buku Keputusan Musyawarah Perencanaan Pembangunan Desa';
    private $_docxName = 'buku_keputusan_ppd.docx';
