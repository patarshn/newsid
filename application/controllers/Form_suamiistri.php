...
class Form_suamiistri extends Frontend_Controller{
    
    private $_table = 'form_suamiistri';
    private $_folder = 'form';
    private $_folderUpload = 'form_suamiistri';
    private $_docxName = 'form_suamiistri';
    private $_mainTitle = 'Form Suami Istri';  
    private $_fileName = 'form_suamiistri';
    ...
    function rulesStore(){
        return [
            ...
            ['field' => 'agama_p', 'label' => 'BINBINTI_P', 'rules' => 'required'],
            ...
            ['field' => 'agama_l', 'label' => 'BINBINTI_L', 'rules' => 'required'],
