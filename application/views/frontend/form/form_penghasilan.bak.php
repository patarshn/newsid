            ...
            <?=form_open(base_url('form_belummenikah/store'),'id="form"')?>
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="pekerjaan_orangtua" id="pekerjaan_orangtua" class="form-control" placeholder="Pekerjaan">
                    </div>
                    <div class="col-lg-6">
                        <label for="penghasilan_orangtua">Penghasilan /bulan (Rp.)</label>
                        <input type="text" name="penghasilan_orangtua" id="penghasilan_orangtua" class="form-control" placeholder="1.800.000">
                    </div>
                    <div class="col-lg-12">
                        <label for="penghasilan_orangtua2">Penghasilan Terbilang</label>
                        <input type="text" name="penghasilan_orangtua2" id="penghasilan_orangtua2" class="form-control" placeholder="Satu Juta Delapan Ratus Ribu Rupiah">
                    </div>
                    <div class="col-lg-12">
