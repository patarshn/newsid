        ...
        <div class="col-lg-8 col-12 konten-form">
            ...
            <?=form_open(base_url('form_belummenikah/store'),'id="form"')?>
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6">
                        <label for="penghasilan">Penghasilan /bulan (Rp.)<span class="text-danger">*</span></label>
                        <input type="text" name="penghasilan" id="penghasilan" class="form-control" placeholder="1.800.000">
                    </div>
                    <div class="col-lg-12">
                        <label for="penghasilan2">Penghasilan Terbilang<span class="text-danger">*</span></label>
                        <input type="text" name="penghasilan2" id="penghasilan2" class="form-control" placeholder="Satu Juta Delapan Ratus Ribu Rupiah">
                    </div>
                    <div class="col-lg-12">
