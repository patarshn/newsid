        ...
        <div class="col-lg-8 col-12 konten-form">
            ...
            <?=form_open(base_url('form_belummenikah/store'),'id="form"')?>
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6">
                        <label for="binbinti">Bin/Binti<span class="text-danger">*</span></label>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label for="tujuan">Alamat Tujuan<span class="text-danger">*</span></label>
                            <textarea class="form-control" name="tujuan" id="tujuan" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <label for="maksud_tujuan">Maksud Tujuan<span class="text-danger">*</span></label>
