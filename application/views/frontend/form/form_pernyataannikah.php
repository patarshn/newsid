        ...
        <div class="col-lg-8 col-12 konten-form">
            ...
            <?=form_open(base_url('form_belummenikah/store'),'id="form"')?>
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6">
                        <label for="agama_l">Agama<span class="text-danger">*</span></label>
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6">
                        <label for="agama_p">Agama<span class="text-danger">*</span></label>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label for="maskawin">Mas Kawin<span class="text-danger">*</span></label>
                            <textarea class="form-control" name="maskawin" id="maskawin" rows="2"></textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <label for="tanggal_kawin">Tanggal Nikah<span class="text-danger">*</span></label>
                        <input type="date" name="tanggal_kawin" id="tanggal_kawin" class="form-control" >
                    </div>
                    <div class="col-lg-6">
                        <label for="jam_kawin">Jam Nikah<span class="text-danger">*</span></label>
