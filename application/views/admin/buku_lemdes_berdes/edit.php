                ...
                ?>
        					...
        					<div class="form-row">
        						<div class="col-lg-6 mt-3">
        							<label for="jns_peraturan_desa" class="text-gray-900 font-weight-bold">Jenis Peraturan di Desa
        								<span class="text-danger">*</span></label>
        							<input type="text" name="jns_peraturan_desa" id="jns_peraturan_desa"
        								class="form-control border-left-primary" value="<?=$d->jns_peraturan_desa?>" maxlength="100"
        								required>
        						</div>
        							...
        							<div class="form-row">
        								<div class="col-lg-6">
        									<input type="text" name="no_ditetapkan" id="no_ditetapkan"
        										class="form-control border-left-primary" value="<?=$d->no_ditetapkan?>" maxlength="100"
        										required>
        								...
        								<div class="col-lg-6">
        									<input type="date" name="tgl_ditetapkan" id="tgl_ditetapkan"
        										...
        										value="<?=$d->tgl_ditetapkan?>" required>
        						...
        						<div class="col-lg-6 mt-3">
        							<label class="text-gray-900 font-weight-bold">Diundangkan <span
        									class="text-danger">*</span></label>
        							<div class="form-row">
        								<div class="col-lg-6">
        									<input type="date" name="tgl_diundangkan" id="tgl_diundangkan"
        										class="form-control border-left-primary" value="<?=$d->tgl_diundangkan?>" required>
        									<small id="tgl_diundangkan" class="text-gray-700">Tanggal</small>
        								</div>

        								<div class="col-lg-6">
        									<input type="text" name="no_diundangkan" id="no_diundangkan"
        										class="form-control border-left-primary" value="<?=$d->no_diundangkan?>" maxlength="100"
        										required>
