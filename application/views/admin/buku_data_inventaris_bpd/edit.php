              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6 mt-3">
                      ...
                      <div class="form-row">
                        <div class="col-lg-2">
                          <input type="text" name="abb_apb_desa" id="abb_apb_desa" class="form-control" value="<?=$d->abb_apb_desa?>" required>
                          <small id="abb_apb_desa" class="text-gray-700">APB Desa</small>
                        </div>
                        
                        <div class="col-lg-2 ml-2">
                          <input type="text" name="bantuan_pemerintah" id="bantuan_pemerintah" class="form-control" value="<?=$d->bantuan_pemerintah?>" required>
                    ...
                    <div class="col-lg-6 mt-3">
                      ...
                      <div class="form-row">
                          <div class="col-lg-3">
                              <input type="text" name="awalthn_baik" id="awalthn_baik" class="form-control" value="<?=$d->awalthn_baik?>" required>
                              <small id="awalthn_baik" class="text-gray-700">Baik</small>
                          </div>
                          
                          <div class="col-lg-3 ml-4">
                              <input type="text" name="awalthn_rusak" id="awalthn_rusak" class="form-control" value="<?=$d->awalthn_rusak?>" required>
                    ...
                    <div class="col-lg-6 mt-3">
                      ...
                      <div class="form-row">
                        <div class="col-lg-2">
                        <input type="text" name="hps_rusak" id="hps_rusak" class="form-control" value="<?=$d->hps_rusak?>" required>
                        <small id="hps_rusak" class="text-gray-700">Rusak</small>
                        </div>
                        
                        <div class="col-lg-2 ml-2">
                        <input type="text" name="hps_dijual" id="hps_dijual" class="form-control" value="<?=$d->hps_dijual?>" required>
                        <small id="hps_dijual" class="text-gray-700">Dijual</small>
                        </div>

                        <div class="col-lg-2 ml-2">
                        <input type="text" name="hps_disumbangkan" id="hps_disumbangkan" class="form-control" value="<?=$d->hps_disumbangkan?>" required>
                    ...
                    <div class="col-lg-6 mt-3">
                      ...
                      <div class="form-row">
                        <div class="col-lg-3">
                          <input type="text" name="akhirthn_baik" id="akhirthn_baik" class="form-control" value="<?=$d->akhirthn_baik?>" required>
                          <small id="akhirthn_baik" class="text-gray-700">Baik</small>
                        </div>

                        <div class="col-lg-3 ml-4">                        
                          <input type="text" name="akhirthn_rusak" id="akhirthn_rusak" class="form-control" value="<?=$d->akhirthn_rusak?>" required>
