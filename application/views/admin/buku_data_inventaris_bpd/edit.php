              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6 mt-3">
                      ...
                      <div class="form-row">
                        <div class="col-lg-2">
                          <input type="number" name="abb_apb_desa" id="abb_apb_desa" class="form-control border-left-primary" value="<?=$d->abb_apb_desa?>" required>
                          <small id="abb_apb_desa" class="text-gray-700">APB Desa</small>
                        </div>
                        
                        <div class="col-lg-2 ml-2">
                          <input type="number" name="bantuan_pemerintah" id="bantuan_pemerintah" class="form-control border-left-primary" value="<?=$d->bantuan_pemerintah?>" required>
                          <small id="bantuan_pemerintah" class="text-gray-700">Bantuan Pemerintah</small>
                        </div>

                        <div class="col-lg-2 ml-2">
                          <input type="number" name="bantuan_prov" id="bantuan_prov" class="form-control border-left-primary" value="<?=$d->bantuan_prov?>" required>
                          <small id="bantuan_prov" class="text-gray-700">Bantuan Provinsi</small>
                        </div>
                        
                        <div class="col-lg-2 ml-2">
                          <input type="number" name="bantuan_kab_kota" id="bantuan_kab_kota" class="form-control border-left-primary" value="<?=$d->bantuan_kab_kota?>" required>
                          <small id="bantuan_kab_kota" class="text-gray-700">Bantuan Kab/Kota</small>
                        </div>
                        
                        <div class="col-lg-2 ml-2">
                          <input type="number" name="abb_sumbangan" id="abb_sumbangan" class="form-control border-left-primary" value="<?=$d->abb_sumbangan?>" required>
                    ...
                    <div class="col-lg-6 mt-3">
                      ...
                      <div class="form-row">
                          <div class="col-lg-3">
                              <input type="number" name="awalthn_baik" id="awalthn_baik" class="form-control border-left-primary" value="<?=$d->awalthn_baik?>" required>
                              <small id="awalthn_baik" class="text-gray-700">Baik</small>
                          </div>
                          
                          <div class="col-lg-3 ml-4">
                              <input type="number" name="awalthn_rusak" id="awalthn_rusak" class="form-control border-left-primary" value="<?=$d->awalthn_rusak?>" required>
                    ...
                    <div class="col-lg-6 mt-3">
                      ...
                      <div class="form-row">
                        <div class="col-lg-2">
                        <input type="number" name="hps_rusak" id="hps_rusak" class="form-control border-left-primary" value="<?=$d->hps_rusak?>" required>
                        <small id="hps_rusak" class="text-gray-700">Rusak</small>
                        </div>
                        
                        <div class="col-lg-2 ml-2">
                        <input type="number" name="hps_dijual" id="hps_dijual" class="form-control border-left-primary" value="<?=$d->hps_dijual?>" required>
                        <small id="hps_dijual" class="text-gray-700">Dijual</small>
                        </div>

                        <div class="col-lg-2 ml-2">
                        <input type="number" name="hps_disumbangkan" id="hps_disumbangkan" class="form-control border-left-primary" value="<?=$d->hps_disumbangkan?>" required>
                    ...
                    <div class="col-lg-6 mt-3">
                      ...
                      <div class="form-row">
                        <div class="col-lg-3">
                          <input type="number" name="akhirthn_baik" id="akhirthn_baik" class="form-control border-left-primary" value="<?=$d->akhirthn_baik?>" required>
                          <small id="akhirthn_baik" class="text-gray-700">Baik</small>
                        </div>

                        <div class="col-lg-3 ml-4">                        
                          <input type="number" name="akhirthn_rusak" id="akhirthn_rusak" class="form-control border-left-primary" value="<?=$d->akhirthn_rusak?>" required>
