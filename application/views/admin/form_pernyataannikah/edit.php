                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="maskawin" id="maskawin" rows="2"><?=$d->maskawin?></textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <label for="tanggal_kawin">Tanggal Nikah</label>
                        <input type="date" name="tanggal_kawin" id="tanggal_kawin" class="form-control" value="<?=$d->tanggal_kawin?>">
                    </div>
                    <div class="col-lg-6">
                        <label for="jam_kawin">Jam Nikah</label>
                        <input type="time" name="jam_kawin" id="jam_kawin" class="form-control" value="<?=$d->jam_kawin?>">
                    </div>
