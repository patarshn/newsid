            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="tanggal_lahir_l">Tanggal Lahir</label>
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="agama_l">Agama</label>
                        <select name="agama_l" id="agama_l" class="form-control border-left-primary" placeholder="Agama" required>
                            <option>-</option>
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="pekerjaan_l">Pekerjaan</label>
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="kabupaten_l">Kabupaten</label>
                    ...
                    <div class="col-lg-3">
                        <label class="text-gray-900 font-weight-bold" for="rt_l">RT</label>
                        <input type="text" name="rt_l" id="rt_l" class="form-control border-left-primary" placeholder="RT" value="<?=$d->rt_l?>" required>
                    </div>
                    <div class="col-lg-3">
                        <label class="text-gray-900 font-weight-bold" for="rw_l">RW</label>
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="tanggal_lahir_p">Tanggal Lahir</label>
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="agama_p">Agama</label>
                        <select name="agama_p" id="agama_p" class="form-control border-left-primary" placeholder="Agama" required>
                            <option>-</option>
                            <option value="Islam">Islam</option>
                            <option value="Kristen">Kristen</option>
                            <option value="Katholik">Katholik</option>
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="pekerjaan_p">Pekerjaan</label>
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="kabupaten_p">Kabupaten</label>
                    ...
                    <div class="col-lg-3">
                        <label class="text-gray-900 font-weight-bold" for="rt_p">RT</label>
                        <input type="text" name="rt_p" id="rt_p" class="form-control border-left-primary" placeholder="RT" value="<?=$d->rt_p?>" required>
                    </div>
                    <div class="col-lg-3">
                        <label class="text-gray-900 font-weight-bold" for="rw_p">RW</label>
                        <input type="text" name="rw_p" id="rw_p" class="form-control border-left-primary" placeholder="RW" value="<?=$d->rw_p?>" required>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="text-gray-900 font-weight-bold" for="maskawin">Mas Kawin</label>
                            <textarea class="form-control border-left-primary" name="maskawin" id="maskawin" rows="2"><?=$d->maskawin?></textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="tanggal_kawin">Tanggal Nikah</label>
                        <input type="date" name="tanggal_kawin" id="tanggal_kawin" class="form-control border-left-primary" value="<?=$d->tanggal_kawin?>">
                    </div>
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="jam_kawin">Jam Nikah</label>
                        <input type="time" name="jam_kawin" id="jam_kawin" class="form-control border-left-primary" value="<?=$d->jam_kawin?>">
                    </div>
                    <div class="col-lg-6">
                ...
                $(document).ready(function(){
                  var agama_l = "<?=$d->agama_l?>";
                  var agama_p = "<?=$d->agama_p?>";
                  $('#agama_l').val(agama_l);
                  $('#agama_p').val(agama_p);
                });
                </script>
