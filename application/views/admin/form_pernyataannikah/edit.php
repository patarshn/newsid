            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="agama_l">Agama<span class="text-danger">*</span></label>
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="agama_p">Agama<span class="text-danger">*</span></label>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="text-gray-900 font-weight-bold" for="maskawin">Mas Kawin<span class="text-danger">*</span></label>
                            <textarea class="form-control border-left-primary" name="maskawin" id="maskawin" rows="2"><?=$d->maskawin?></textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="tanggal_kawin">Tanggal Nikah<span class="text-danger">*</span></label>
                        <input type="date" name="tanggal_kawin" id="tanggal_kawin" class="form-control border-left-primary" value="<?=$d->tanggal_kawin?>">
                    </div>
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="jam_kawin">Jam Nikah<span class="text-danger">*</span></label>
