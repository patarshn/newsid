          ...
          <?php if($this->session->flashdata('success_message')): ?>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <?=form_open(base_url('buku_peraturan_desa/store'),'id="form"')?>
                <h3 class="text-gray-900"><?=$title?></h3>
                <div class="form-row">
                    <div class="col-lg-6 mt-3">
                        <label for="jenis_peraturan_desa" class="text-gray-900 font-weight-bold">Jenis Peraturan Desa</label>
                        <input type="text" name="jenis_peraturan_desa" id="jenis_peraturan_desa" class="form-control" placeholder="Jenis Peraturan Desa"  required>
                    </div>

                    <div class="col-lg-6 mt-3">
                        <label for="no_dan_tgl_ditetapkan" class="text-gray-900 font-weight-bold">Nomor dan Tanggal ditetapkan</label>
                        <input type="text" name="no_dan_tgl_ditetapkan" id="no_dan_tgl_ditetapkan" class="form-control" placeholder="Nomor dan Tanggal ditetapkan"  required>
                    </div>

                    <div class="col-lg-6 mt-3">
                        <label for="tentang" class="text-gray-900 font-weight-bold">Tentang</label>
                        <input type="text" name="tentang" id="tentang" class="form-control" placeholder="tentang"  required>
                    </div>
                    ...
                    <div class="col-lg-6 mt-3">
                        ...
                        <input type="text" name="no_dan_tgl_dilaporkan" id="no_dan_tgl_dilaporkan" class="form-control" placeholder="Nomor dan Tanggal Dilaporkan"  required>
                    </div>
                    ...
                    <div class="col-lg-6 mt-3">
                        ...
                        <input type="text" name="no_dan_tgl_diundangkan_dalam_lembaran_desa" id="no_dan_tgl_diundangkan_dalam_lembaran_desa" class="form-control" placeholder="Nomor dan Tanggal Diundangkan Dalam Lembaran Desa"  required>
                    </div>
                    ...
                    <div class="col-lg-6 mt-3">
                        ...
                        <input type="text" name="no_dan_tgl_diundangkan_dalam_berita_desa" id="no_dan_tgl_diundangkan_dalam_berita_desa" class="form-control" placeholder="Nomor dan Tanggal Diundangkan Dalam Berita Desa"  required>
                    </div>
