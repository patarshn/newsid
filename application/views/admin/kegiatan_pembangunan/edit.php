                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="waktu" id="waktu" class="form-control border-left-info " placeholder="waktu" value="<?=$d->waktu?>" required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="sifat" id="sifat" class="form-control border-left-info " placeholder="sifat" value="<?=$d->sifat?>" required>
                        </div>
                    </div>
