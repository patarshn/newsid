                ...
                <div class="form-row">
                  <input type="hidden" name="id" id="id" class="form-control" value="<?=$d->id?>" required>
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="agama" id="agama" class="form-control" value="<?=$d->agama?>" required>
                    </div>
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="kehilangan" id="kehilangan" rows="3" required><?=$d->kehilangan?></textarea>
                        </div>
                    </div>
