              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body"> 
                  ...
                  <?php foreach($data as $d):?>
                    ...
                    <h5 class="text-gray-900 font-weight-bold">Data Rekapitulasi Jumlah Penduduk Dusun: <?=$d->dusun?></h5>
                    <h5 class="text-gray-900 font-weight-bold">Periode: <?= date("m-Y", strtotime($d->bulan_tahun))?></h5>
                    </div>
                                  <div class="row">
                                      <div class="col-lg-12">
