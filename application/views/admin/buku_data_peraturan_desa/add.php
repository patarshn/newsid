              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                    <div class="col-lg-6 mt-3">
                        ...
                        <input type="text" name="no_dan_tgl_peraturan_desa" id="no_dan_tgl_peraturan_desa" class="form-control" required>
                    </div>
                    ...
                    <div class="col-lg-6 mt-3">
                        ...
                        <input type="text" name="no_dan_tgl_kesepakatan" id="no_dan_tgl_kesepakatan" class="form-control" required>
                    </div>
