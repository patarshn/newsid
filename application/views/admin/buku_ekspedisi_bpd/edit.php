            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6 mt-3">
                        <label for="no_surat" class="text-gray-900 font-weight-bold">Nomor Surat</label>
                        <input type="text" name="no_surat" id="no_surat" class="form-control border-left-primary" value="<?=$d->no_surat?>" required>
                    </div>
                    
                    <div class="col-lg-6 mt-3">
                        <label for="tgl_surat" class="text-gray-900 font-weight-bold">Tanggal Surat</label>
                        <input type="date" name="tgl_surat" id="tgl_surat" class="form-control border-left-primary" placeholder="mm/dd/yy" value="<?=$d->tgl_surat?>" required>
                    </div>
