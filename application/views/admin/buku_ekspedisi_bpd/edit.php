          ...
          <?php if($this->session->flashdata('success_message')): ?>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <?php echo form_open(base_url('buku_ekspedisi/update'),'id="form"');
                foreach($data as $d):
                ?>
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6 mt-3">
                        <label for="no_dan_tgl_surat" class="text-gray-900 font-weight-bold">Nomor dan Tanggal Surat</label>
                        <input type="text" name="no_dan_tgl_surat" id="no_dan_tgl_surat" class="form-control" value="<?=$d->no_dan_tgl_surat?>" required>
                    </div>
                    ...
                    <div class="col-lg-12 mt-3">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="tujuan" id="tujuan" rows="3" required><?=$d->tujuan?></textarea>
                        </div>
                    </div>
