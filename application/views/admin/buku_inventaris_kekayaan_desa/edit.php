                ...
                ?>
        					...
        					<div class="form-row">
        						<div class="col-lg-6 mt-3">
        							<label for="jenis_brng_bangunan" class="text-gray-900 font-weight-bold">Jenis Barang
        								atau Bangunan
        								<span class="text-danger">*</span></label>
        							<input type="text" name="jenis_brng_bangunan" id="jenis_brng_bangunan"
        								class="form-control border-left-primary" value="<?=$d->jenis_brng_bangunan?>"
        							...
        							<div class="form-row">
        								<div class="col-lg-2">
        									<input type="text" name="abb_dibeli_sendiri" id="abb_dibeli_sendiri"
        										...
        										value="<?=$d->abb_dibeli_sendiri?>"
        										onkeypress="return onlyNumberKey(event)" required>
        									<small id="abb_dibeli_sendiri" class="text-gray-700">Dibeli Sendiri</small>
        								</div>

        								<div class="col-lg-2 ml-2">
        									<input type="text" name="bantuan_pemeritah" id="bantuan_pemeritah"
        										class="form-control border-left-primary"
        										value="<?=$d->bantuan_pemeritah?>"
        										onkeypress="return onlyNumberKey(event)" required>
        									<small id="bantuan_pemeritah" class="text-gray-700">Bantuan
        										Pemerintah</small>
        								</div>
        								...
        								<div class="col-lg-2 ml-2">
        									<input type="text" name="abb_sumbangan" id="abb_sumbangan"
        										class="form-control border-left-primary" value="<?=$d->abb_sumbangan?>"
        										onkeypress="return onlyNumberKey(event)" required>
        							...
        							<div class="form-row">
        								<div class="col-lg-2">
        									<input type="text" name="rusak_hps" id="rusak_hps"
        										class="form-control border-left-primary" value="<?=$d->rusak_hps?>"
        										onkeypress="return onlyNumberKey(event)" required>
        									<small id="rusak_hps" class="text-gray-700">Rusak</small>
        								</div>

        								<div class="col-lg-2 ml-2">
        									<input type="text" name="dijual_hps" id="dijual_hps"
        										class="form-control border-left-primary" value="<?=$d->dijual_hps?>"
        										onkeypress="return onlyNumberKey(event)" required>
        									<small id="dijual_hps" class="text-gray-700">Dijual</small>
        								</div>

        								<div class="col-lg-2 ml-2">
        									<input type="text" name="disumbangkan_hps" id="disumbangkan_hps"
        										class="form-control border-left-primary"
        										value="<?=$d->disumbangkan_hps?>"
        										onkeypress="return onlyNumberKey(event)" required>
        									<small id="disumbangkan_hps" class="text-gray-700">Disumbangkan</small>
        								</div>

        								<div class="col-lg-4 ml-2">
        									<input type="date" name="tgl_hapus" id="tgl_hapus"
        										class="form-control border-left-primary" value="<?=$d->tgl_hapus?>"
        										required>
        							...
        							<div class="form-row">
        								<div class="col-lg-3">
        									<input type="text" name="baik_awalthn" id="baik_awalthn"
        										class="form-control border-left-primary" value="<?=$d->baik_awalthn?>"
        										onkeypress="return onlyNumberKey(event)" required>
        									<small id="baik_awalthn" class="text-gray-700">Baik</small>
        								</div>

        								<div class="col-lg-3 ml-4">
        									<input type="text" name="rusak_awalthn" id="rusak_awalthn"
        										class="form-control border-left-primary" value="<?=$d->rusak_awalthn?>"
        										onkeypress="return onlyNumberKey(event)" required>
        							...
        							<div class="form-row">
        								<div class="col-lg-3">
        									<input type="text" name="baik_akhirthn" id="baik_akhirthn"
        										class="form-control border-left-primary" value="<?=$d->baik_akhirthn?>"
        										onkeypress="return onlyNumberKey(event)" required>
        									<small id="baik_akhirthn" class="text-gray-700">Baik</small>
        								</div>

        								<div class="col-lg-3 ml-4">
        									<input type="text" name="rusak_akhirthn" id="rusak_akhirthn"
        										class="form-control border-left-primary" value="<?=$d->rusak_akhirthn?>"
        										onkeypress="return onlyNumberKey(event)" required>
        						...
        						<div class="col-lg-12 form-inline">
        							...
        							<div class="form-check form-check-inline">
        								<input type="radio" name="ver_kepala_desa" id="ver_kepala_desa2"
