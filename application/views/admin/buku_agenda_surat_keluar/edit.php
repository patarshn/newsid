              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6 mt-3">
                        ...
                        <input type="date" name="tgl_surat_keluar" id="tgl_surat_keluar" class="form-control border-left-primary" placeholder="mm/dd/yy" value="<?=$d->tgl_surat_keluar?>" required>
                    </div>
