          ...
          <?php if($this->session->flashdata('success_message')): ?>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <?=form_open_multipart(base_url('buku_agenda_surat_keluar/store'),'id="form"')?>
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6 mt-3">
                        ...
                        <input type="text" name="no_dan_tgl_surat_keluar" id="no_dan_tgl_surat_keluar" class="form-control" required>
                    </div>
