          ...
          <?php if($this->session->flashdata('success_message')): ?>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <?php echo form_open(base_url('buku_keputusan_musyawarah/update'),'id="form"');
                foreach($data as $d):
                ?>
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6 mt-3">
                        ...
                        <input type="text" name="ttg" id="ttg" class="form-control border-left-primary" value="<?=$d->ttg?>" required>
                    </div>
                    ...
                    <div class="col-lg-12 mt-3">
                        <div class="form-group">
                            ...
                            <textarea class="form-control border-left-primary" name="ppk" id="ppk" rows="3" required><?=$d->ppk?></textarea>
                        </div>
                    </div>
