          ...
          <?php if($this->session->flashdata('success_message')): ?>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <?=form_open(base_url('mutasi_penduduk/store'),'id="form"')?>
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6">
                            ...
                            <input type="text" name="datang_dari" id="datang_dari" class="form-control border-left-info " placeholder="Asal Kedatangan">
                        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="date" name="tgl_datang" id="tgl_datang" class="form-control border-left-info" placeholder="" >
                    </div>
                    ...
                    <div class="col-lg-6">
                            ...
                            <input type="text" name="pindah" id="pindah" class="form-control border-left-info " placeholder="Asal Kedatangan">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tgl_lahir" id="tgl_lahir" class="form-control border-left-info" placeholder="Tanggal Lahir" required>
                    </div>
                    </div>

                    <div class="col-lg-6">
                        <label for="tgl_pindah"><b>Tanggal Pindah</b></label>
                        <input type="date" name="tgl_pindah" id="tgl_pindah" class="form-control border-left-info" placeholder="">
                    </div>
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="text" name="meninggal" id="meninggal" class="form-control border-left-info" placeholder="">
                    </div>

                    <div class="col-lg-3">
                        <label for="tgl_meninggal"><b>Tanggal Meninggal</b></label>
                        <input type="date" name="tgl_meninggal" id="tgl_meninggal" class="form-control border-left-info" placeholder="">
                    </div>
