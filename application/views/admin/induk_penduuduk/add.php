                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="nokk" id="nokk" class="form-control border-left-info " placeholder="No. KK"  required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="nama" class="form-control border-left-info" placeholder="Nama" required>
                        </div>
                    </div>

                    <div class="col-lg-6">
                            <label for="wn"><b>Kewarganegaraan</b></label>
                            <input type="text" name="wn" id="wn" class="form-control border-left-info " placeholder="satatus kewarganegaraan"  required>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="jk" id="jk" class="form-control border-left-info " placeholder="jk"  required>
                        </div>
                    </div>

                    <div class="col-lg-6">
                        <label for="stkawin"><b>Startus Perkawinan</b></label>
                        <input type="text" name="stkawin" id="stkawin" class="form-control border-left-info" placeholder="Statur Pekawinan" required>
                    </div>

                    <div class="col-lg-6">
                    <div class="form-group">
                        <label for="tempat_lahir"><b>Tempat Lahir</b></label>
                        <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control border-left-info" placeholder=""  required>
                    </div>
                    </div>

                    <div class="col-lg-6">
                        <label for="pendidikan"><b>Pendidikan Terakhir</b></label>
                        <input type="text" name="pendidikan" id="pendidikan" class="form-control border-left-info" placeholder="pendidikan terahir"   required>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="baca_huruf" id="baca_huruf" class="form-control border-left-info " placeholder=""  required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="agama" id="agama" class="form-control border-left-info" placeholder="agama"  required>
                    </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="pekerjaan" id="pekerjaan" class="form-control border-left-info " placeholder="kedudukan di keluarga"  required>
                        </div>
                    </div>
