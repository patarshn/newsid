            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6">
                        <label for="binbinti_p">Bin/Binti</label>
                        <input type="text" name="binbinti_p" id="binbinti_p" class="form-control" placeholder="bin/binti" value="<?=$d->binbinti_p?>" required>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6">
                        <label for="binbinti_l">Bin/Binti</label>
                        <input type="text" name="binbinti_l" id="binbinti_l" class="form-control" placeholder="bin/binti" value="<?=$d->binbinti_l?>" required>
                    </div>
                    <div class="col-lg-6">
