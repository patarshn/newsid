              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6 mt-3">
                        ...
                        <input type="date" name="tgl_keputusan_pengangkatan" id="tgl_keputusan_pengangkatan" class="form-control border-left-primary" value="<?=$d->tgl_keputusan_pengangkatan?>" required>
                    </div>
                    ...
                    <div class="col-lg-6 mt-3">
                        ...
                        <input type="date" name="tgl_keputusan_pemberhentian" id="tgl_keputusan_pemberhentian" class="form-control border-left-primary" value="<?=$d->tgl_keputusan_pemberhentian?>" required>
                    </div>
