              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                    <div class="col-lg-6 mt-3">
                        ...
                        <input type="text" name="nama" id="nama" class="form-control border-left-primary" value="<?=$d->nama?>" required onkeypress='return harusHuruf(event)'>
                    </div>

                    <div class="col-lg-6 mt-3">
                        <label for="nip" class="text-gray-900 font-weight-bold">NIP</label>
                        <medium id="wajib" class="text-danger">*</medium>
                        <input type="number " name="nip" id="nip" class="form-control border-left-primary" value="<?=$d->nip?>" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57" required>
