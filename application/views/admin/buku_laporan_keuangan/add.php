              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-6 mt-3">
                        ...
                        <input type="text" name="jml_penerimaan" id="jml_penerimaan" class="form-control" required>
                    </div>

                    <div class="col-lg-6 mt-3">
                        <label for="jml_pengeluaran" class="text-gray-900 font-weight-bold">Jumlah Pengeluaran</label>
                        <input type="text" name="jml_pengeluaran" id="jml_pengeluaran" class="form-control" required>
                    </div>
