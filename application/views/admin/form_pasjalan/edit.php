                ...
                <div class="form-row">
                  <input type="hidden" name="id" id="id" class="form-control" value="<?=$d->id?>" required>
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="binbinti" id="binbinti" class="form-control" placeholder="Bin/Binti" value="<?=$d->binbinti?>" required>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="tujuan" id="tujuan" rows="3"><?=$d->tujuan?></textarea>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <label for="maksud_tujuan">Maksud Tujuan</label>
                        <input type="text" name="maksud_tujuan" id="maksud_tujuan" class="form-control" value="<?=$d->maksud_tujuan?>" placeholder="Maksud Tujuan">
                    </div>
                    <div class="col-lg-6">
                        <label for="tanggal_berangkat">Tanggal Berangkat</label>
                        <input type="date" name="tanggal_berangkat" id="tanggal_berangkat" class="form-control" value="<?=$d->tanggal_berangkat?>" placeholder="mm/dd/yy" required>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
