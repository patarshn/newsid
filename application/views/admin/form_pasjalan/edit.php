              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                  <input type="hidden" name="id" id="id" class="form-control border-left-primary" value="<?=$d->id?>" required>
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="binbinti">Bin/Binti</label>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="text-gray-900 font-weight-bold" for="tujuan">Alamat Tujuan</label>
                            <textarea class="form-control border-left-primary" name="tujuan" id="tujuan" rows="3"><?=$d->tujuan?></textarea>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <label class="text-gray-900 font-weight-bold" for="maksud_tujuan">Maksud Tujuan</label>
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="tanggal_berangkat">Tanggal Berangkat</label>
