              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                  <input type="hidden" name="id" id="id" class="form-control border-left-primary" value="<?=$d->id?>" required>
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="binbinti">Bin/Binti<span class="text-danger">*</span></label>
                        <input type="text" name="binbinti" id="binbinti" class="form-control border-left-primary" placeholder="Bin/Binti" value="<?=$d->binbinti?>" required>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="status_perkawinan">Status Perkawinan<span class="text-danger">*</span></label>
                        <input type="text" name="status_perkawinan" id="status_perkawinan" class="form-control border-left-primary" placeholder="Status Perkawinan" value="<?=$d->status_perkawinan?>">
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="text-gray-900 font-weight-bold" for="tujuan">Alamat Tujuan<span class="text-danger">*</span></label>
                            <textarea class="form-control border-left-primary" name="tujuan" id="tujuan" rows="3"><?=$d->tujuan?></textarea>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <label class="text-gray-900 font-weight-bold" for="maksud_tujuan">Maksud Tujuan<span class="text-danger">*</span></label>
                        <input type="text" name="maksud_tujuan" id="maksud_tujuan" class="form-control border-left-primary" value="<?=$d->maksud_tujuan?>" placeholder="Maksud Tujuan">
                    </div>
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="tanggal_berangkat">Tanggal Berangkat<span class="text-danger">*</span></label>
                        <input type="date" name="tanggal_berangkat" id="tanggal_berangkat" class="form-control border-left-primary" value="<?=$d->tanggal_berangkat?>" placeholder="mm/dd/yy" required>
                    </div>
                    <div class="col-lg-6">
