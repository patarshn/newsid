                    ...
                    <div class="col-lg-6 mt-3">
                      ...
                      <div class="form-row">
                        ...
                        <div class="col-lg-3">                        
                          ...
                          <small id="blm_serti_vi" class="text-gray-700">Luas Hak Verponding Indonesia</small>
                        </div>
                    ...
                    <div class="col-lg-6 mt-3">
                      ...
                      <div class="form-row">
                        ...
                        <div class="col-lg-3">                        
                          ...
                          <small id="non_pertanian_dagang_jasa" class="text-gray-700">Luas Perdagangan dan Jasa</small>
                        </div>
                        ...
                        <div class="col-lg-3 mt-2">                        
                          ...
                          <small id="non_pertanian_fasilitas_umum" class="text-gray-700">Luas Fasilitas Umum</small>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-12 mt-3">
                      ...
                      <div class="form-row">
                        ...
                        <div class="col-lg-2">                        
                          ...
                          <small id="pertanian_ternak" class="text-gray-700">Luas Peternakan/Perikanan</small>
                        </div>
                        ...
                        <div class="col-lg-2">                        
                          ...
                          <small id="pertanian_hutan_lindung" class="text-gray-700">Luas Hutan Lebat/Lindung</small>
                        </div>

                        <div class="col-lg-2 mt-2">                        
                          <input type="date" name="pertanian_mutasi" id="pertanian_mutasi" class="form-control border-left-primary" required>
                          <small id="pertanian_mutasi" class="text-gray-700">Mutasi Tanah di Desa (diisi setiap terjadi mutasi tanah)</small>
                        </div>

                        <div class="col-lg-2 mt-2">                        
                          <input type="text" name="pertanian_tanah_kosong" id="pertanian_tanah_kosong" class="form-control border-left-primary" required>
                          <small id="pertanian_tanah_kosong" class="text-gray-700">Luas Tanah Kosong</small>
                        </div>

                        <div class="col-lg-2 mt-2">                        
                          <input type="text" name="pertanian_lain" id="pertanian_lain" class="form-control border-left-primary" required>
                          <small id="pertanian_lain" class="text-gray-700">Luas Tanah Untuk Lain-Lain</small>
                        </div>
                      </div>
                    </div>
