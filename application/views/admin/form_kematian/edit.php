                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="tempat_kematian" id="tempat_kematian" class="form-control" placeholder="Tempat Kematian" value="<?=$d->tempat_kematian?>" required>
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="tempat_pemakaman" id="tempat_pemakaman" class="form-control" placeholder="Tempat pemakaman" value="<?=$d->tempat_pemakaman?>" required>
                            </div>
                        </div>
                    </div>
