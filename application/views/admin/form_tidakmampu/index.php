                  ...
                  foreach ($data as $d): ?>
                    ...
                    <td><?=$count++;?></td>
                      <td><div class="dropdown no-arrow">
                        <a class="dropdown-toggle dropdown-toggle btn btn-sm btn-secondary" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
