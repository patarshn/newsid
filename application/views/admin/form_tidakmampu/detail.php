                ...
                <div class="card-body">
                  ...
                  <?php foreach($data as $d):
                    ...
                    <table class="table table-bordered table-hover border-left-primary mt-3"cellpadding="6">
                        ...
                        <tr>
                            <td colspan="3"><h5><u>Data Orang Tua</u></h5></td>
                        </tr>
                        <tr>
                            <td>NIK</td>
                            <td>:</td>
                            <td><?=$d->nik_orangtua?></td>
                        </tr>
                        <tr>
                            <td>Nama</td>
                            <td>:</td>
                        ...
                        <tr>
                            <td>Tempat Lahir</td>
                            <td>:</td>
                            <td><?=$d->tempat_lahir_orangtua?></td>
                        </tr>
                        <tr>
                            <td>Tanggal Lahir</td>
                            <td>:</td>
                            <td><?=$d->tanggal_lahir_orangtua?></td>
                        </tr>
                        <tr>
                            <td>Kewarganegaraan</td>
                            <td>:</td>
                            <td><?=$d->kewarganegaraan_orangtua?></td>
                        </tr>
                        <tr>
                            <td>Agama</td>
                            <td>:</td>
                            <td><?=$d->agama_orangtua?></td>
                        </tr>
                        <tr>
                            <td>Pekerjaan</td>
                            <td>:</td>
