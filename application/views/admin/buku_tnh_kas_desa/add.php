              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                    <div class="col-lg-6 mt-3">
                        ...
                        <input type="text" name="asal_tnh_kas" id="asal_tnh_kas" class="form-control border-left-primary" required>
                    </div>

                    <div class="col-lg-6 mt-3">
                        <label for="no_serti_letterc_persil" class="text-gray-900 font-weight-bold">Nomor Sertifikat Buku Letter C/Persil</label>
                        <input type="text" name="no_serti_letterc_persil" id="no_serti_letterc_persil" class="form-control border-left-primary" required>
                    </div>
                    ...
                    <div class="col-lg-6 mt-3">
                      ...
                      <div class="form-row">
                        <div class="col-lg-3">
                          <input type="text" name="peroleh_asli_milik_desa" id="peroleh_asli_milik_desa" class="form-control border-left-primary" required>
                          <small id="peroleh_asli_milik_desa" class="text-gray-700">Asli Milik Desa</small>
                        </div>

                        <div class="col-lg-3">                        
                          <input type="text" name="bantuan_pem" id="bantuan_pem" class="form-control border-left-primary" required>
                        ...
                        <div class="col-lg-3 mt-2">                        
                          <input type="text" name="peroleh_lain" id="peroleh_lain" class="form-control border-left-primary" required>
                          <small id="peroleh_lain" class="text-gray-700">Lain-Lain</small>
                        </div>

                        <div class="col-lg-4 mt-2">                        
                          <input type="date" name="tgl_peroleh" id="tgl_peroleh" class="form-control border-left-primary" placeholder="mm/dd/yy" required>
                    ...
                    <div class="col-lg-6 mt-3">
                      ...
                      <div class="form-row">
                        <div class="col-lg-3">
                          <input type="text" name="jenis_sawah" id="jenis_sawah" class="form-control border-left-primary" required>
                          <small id="jenis_sawah" class="text-gray-700">Sawah</small>
                        </div>

                        <div class="col-lg-3">                        
                          <input type="text" name="jenis_tegal" id="jenis_tegal" class="form-control border-left-primary" required>
                          <small id="jenis_tegal" class="text-gray-700">Tegal</small>
                        </div>

                        <div class="col-lg-3">                        
                          <input type="text" name="jenis_kebun" id="jenis_kebun" class="form-control border-left-primary" required>
                          <small id="jenis_kebun" class="text-gray-700">Kebun</small>
                        </div>

                        <div class="col-lg-3">                        
                          <input type="text" name="jenis_tambak" id="jenis_tambak" class="form-control border-left-primary" required>
                          <small id="jenis_tambak" class="text-gray-700">Tambak/Kolam</small>
                        </div>

                        <div class="col-lg-3 mt-2">                        
                          <input type="text" name="jenis_darat" id="jenis_darat" class="form-control border-left-primary" required>
                    ...
                    <div class="col-lg-6 mt-3">
                      ...
                      <div class="form-row">
                        <div class="col-lg-3">
                          <input type="text" name="patok_ada" id="patok_ada" class="form-control border-left-primary" required>
                          <small id="patok_ada" class="text-gray-700">Ada</small>
                        </div>

                        <div class="col-lg-3">                        
                          <input type="text" name="patok_tdkada" id="patok_tdkada" class="form-control border-left-primary" required>
                    ...
                    <div class="col-lg-6 mt-3">
                      ...
                      <div class="form-row">
                        <div class="col-lg-3">
                          <input type="text" name="papan_ada" id="papan_ada" class="form-control border-left-primary" required>
                          <small id="papan_ada" class="text-gray-700">Ada</small>
                        </div>

                        <div class="col-lg-3">                        
                          <input type="text" name="papan_tdkada" id="papan_tdkada" class="form-control border-left-primary" required>
                    ...
                    <div class="col-lg-6 mt-3">
                        ...
                        <input type="text" name="lokasi" id="lokasi" class="form-control border-left-primary" required>
                    </div>

                    <div class="col-lg-6 mt-3">
                        <label for="peruntukkan" class="text-gray-900 font-weight-bold">Peruntukkan</label>
                        <input type="text" name="peruntukkan" id="peruntukkan" class="form-control border-left-primary" required>
                    </div>
