        					...
        					<div class="form-row">
        						...
        						<div class="col-lg-6 mt-3">
        							...
        							<input type="text" name="luas" id="luas" class="form-control border-left-primary"
        								onkeypress="return onlyNumberKey(event)" placeholder="contoh : 2.5" required>
        							...
        							<div class="form-row">
        								...
        								<div class="col-lg-4 mt-2">
        									<input type="date" name="tgl_peroleh" id="tgl_peroleh"
        										class="form-control border-left-primary" placeholder="mm/dd/yy"
        										required>
        						...
        						<div class="col-lg-6 mt-3">
        							...
        							<small id="mutasi" class="text-gray-700">Diisi setiap terjadi mutasi tanah kas
        								Desa</small>
        						</div>
