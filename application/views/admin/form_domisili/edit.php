              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                  <input type="hidden" name="id" id="id" class="form-control border-left-primary" value="<?=$d->id?>" required>
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="nama">Status Perkawinan<span class="text-danger">*</span></label>
                        <input type="text" name="status_perkawinan" id="status_perkawinan" class="form-control border-left-primary" value="<?=$d->kewarganegaraan?>" required>
                    </div>
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="nama">Pekerjaan<span class="text-danger">*</span></label>
                        <input type="text" name="pekerjaan" id="pekerjaan" class="form-control border-left-primary" value="<?=$d->kewarganegaraan?>" required>
                    </div>
                    <div class="col-lg-6">
