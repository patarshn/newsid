              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                    <div class="col-lg-12">
                        ...
                        <input type="text" name="nama_usaha" id="nama_usaha" class="form-control" value="<?=$d->nama_usaha?>" placeholder="Nama Usaha">
                    </div>     
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label for="alamat_usaha">Alamat</label>
                            <textarea class="form-control" name="alamat_usaha" id="alamat_usaha" rows="3"><?=$d->alamat_usaha?></textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <label for="pekon_usaha">Pekon</label>
                        <input type="text" name="pekon_usaha" id="pekon_usaha" class="form-control" value="<?=$d->pekon_usaha?>">
                    </div>
                    <div class="col-lg-6">
                        <label for="kecamatan_usaha">Kecamatan</label>
                        <input type="text" name="kecamatan_usaha" id="kecamatan_usaha" class="form-control" value="<?=$d->kecamatan_usaha?>">
                    </div>
                    <div class="col-lg-6">
                        <label for="kabupaten_usaha">Kabupaten</label>
                        <input type="text" name="kabupaten_usaha" id="kabupaten_usaha" class="form-control" value="<?=$d->kabupaten_usaha?>">
                    </div>
                    <div class="col-lg-3">
                        <label for="rt_usaha">RT</label>
                        <input type="text" name="rt_usaha" id="rt_usaha" class="form-control" value="<?=$d->rt_usaha?>" placeholder="RT">
                    </div>
                    <div class="col-lg-3">
                        <label for="rw_usaha">RW</label>
                        <input type="text" name="rw_usaha" id="rw_usaha" class="form-control" value="<?=$d->rw_usaha?>" placeholder="RW">
                    </div>     
                    <div class="col-lg-12">
                        <label for="persyaratan">Persyaratan</label>
                        <input type="text" name="persyaratan" id="persyaratan" class="form-control" placeholder="Masa Berlaku" value="<?=$d->persyaratan?>">
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
