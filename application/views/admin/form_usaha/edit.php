          ...
          <?php if($this->session->flashdata('success_message')): ?>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                    <div class="col-lg-12">
                        <label class="text-gray-900 font-weight-bold" for="nama_usaha">Nama Usaha</label>
