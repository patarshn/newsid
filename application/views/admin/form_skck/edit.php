                ...
                <div class="form-row">
                  <input type="hidden" name="id" id="id" class="form-control" value="<?=$d->id?>" required>
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="bin_binti" id="bin_binti" class="form-control" placeholder="Bin/Binti" value="<?=$d->bin_binti?>" required>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="pekerjaan" id="pekerjaan" class="form-control" placeholder="Pekerjaan" value="<?=$d->bin_binti?>" required>
                    </div>
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="keterangan" id="keterangan" rows="2" required placeholder="1.  Berkelakuan baik 
