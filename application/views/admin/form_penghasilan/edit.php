              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                  <input type="hidden" name="id" id="id" class="form-control" value="<?=$d->id?>" required>
                    ...
                    <div class="col-lg-6">
                        <label for="penghasilan">Penghasilan /bulan (Rp.)</label>
                        <input type="text" name="penghasilan" id="penghasilan" class="form-control" placeholder="1.800.000" value="<?=$d->penghasilan?>">
                    </div>
                    <div class="col-lg-12">
                        <label for="penghasilan2">Penghasilan Terbilang</label>
                        <input type="text" name="penghasilan2" id="penghasilan2" class="form-control" placeholder="Satu Juta Delapan Ratus Ribu Rupiah" value="<?=$d->penghasilan2?>">
                    </div>
                    <div class="col-lg-12">
