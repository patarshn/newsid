              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                  <input type="hidden" name="id" id="id" class="form-control border-left-primary" value="<?=$d->id?>" required>
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="penghasilan">Penghasilan /bulan (Rp.)</label>
                    ...
                    <div class="col-lg-12">
                        <label class="text-gray-900 font-weight-bold" for="penghasilan2">Penghasilan Terbilang</label>
