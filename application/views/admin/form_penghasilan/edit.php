              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-row">
                  <input type="hidden" name="id" id="id" class="form-control border-left-primary" value="<?=$d->id?>" required>
                    ...
                    <div class="col-lg-6">
                        <label class="text-gray-900 font-weight-bold" for="penghasilan">Penghasilan /bulan (Rp.)<span class="text-danger">*</span></label>
                        <input type="text" name="penghasilan" id="penghasilan" class="form-control border-left-primary" placeholder="1.800.000" value="<?=$d->penghasilan?>">
                    </div>
                    <div class="col-lg-12">
                        <label class="text-gray-900 font-weight-bold" for="penghasilan2">Penghasilan Terbilang<span class="text-danger">*</span></label>
                        <input type="text" name="penghasilan2" id="penghasilan2" class="form-control border-left-primary" placeholder="Satu Juta Delapan Ratus Ribu Rupiah" value="<?=$d->penghasilan2?>">
                    </div>
                    <div class="col-lg-12">
